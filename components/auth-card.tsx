...
export function AuthCard() {
  ...
  function handleVerify(e: React.FormEvent) {
    ...
    // Simulate verifying code (Accepts ANY 6 digits)
    setTimeout(() => {
      setLoading(false)
      router.push('/dashboard') // Change to your preferred route (e.g. '/' or '/menu')
      router.refresh()
    }, 800)
  }
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <p className="text-pretty text-xs leading-relaxed text-muted-foreground">
            <span className="font-semibold text-foreground">Demo Mode:</span> Authentication is
            simulated. Type any valid email and enter any 6 digits to log in.
          </p>
        </div>
